...
using TTS_Live_UI.Core.Services;
using TTS_Live_UI.Helpers;
using TTS_Live_UI.Models;
using TTS_Live_UI.Services;
using TTS_Live_UI.ViewModels;
using TTS_Live_UI.Views;

namespace TTS_Live_UI;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<IntroduçãoPage>();
            services.AddTransient<SettingsViewModel>();
            services.AddTransient<SettingsPage>();
            services.AddTransient<EditorDetailViewModel>();
